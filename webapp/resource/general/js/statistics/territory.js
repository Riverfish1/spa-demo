(function($, Stats, appName, Highcharts){
    ...
    var TerritoryView = Stats.View.extend({
        ...
        getUrl: function() {
            if(this.options.tmplId == 'territory-inland-tpl'){
                return appName + '../resource/devData/inland.json';
            }else{
                return appName + '../resource/devData/nation.json';
            }
    ...
    Stats.Views.InlandView = TerritoryView.extend({
        ...
        init: function() {
            ...
            this.national = new NationalView();
        },
   ...
   var NationalView = TerritoryView.extend({
        default: $.extend({}, TerritoryView.prototype.default, {
            mapChartId: 'chart',
